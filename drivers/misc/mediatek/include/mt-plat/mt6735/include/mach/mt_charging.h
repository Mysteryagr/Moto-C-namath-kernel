...
/*baidabin modified for low temp charger current*/
#define WT_BAT_CHARGE_CURRENT_TEMP_LIMIT
#ifdef WT_BAT_CHARGE_CURRENT_TEMP_LIMIT
#define AC_CHARGER_CURRENT_LOW_TEMP 45000 
#endif
/*baidabin modified for high temp charger volt*/
#define WT_BAT_CHARGE_CV_TEMP_LIMIT
#ifdef WT_BAT_CHARGE_CV_TEMP_LIMIT
#define BATTERY_CV_VOLT_HIGH_TEMP 4100000
#define BATTERY_TOPOFF_VOLT_HIGH_TEMP 3950  /*waiting for modified*/
#define BATTERY_RECHARGE_VOLT_HIGH_TEMP 4000
#endif
